...
export interface Offre { id: number; designation: string; typePropose: TypeComposant; marque: string; modele: string; reference: string; categorieId: number; etatDeclare: EtatDeclare; prixPropose: number; description?: string; images: string[]; dateOffre: string; statut: StatutOffre; entrepriseId: number; composantId?: number; entreprise?: { id?: number; nom: string; contact: string; adresse?: string } }
