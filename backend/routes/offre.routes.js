...
import { submitOffreSchema, listOffresSchema, offreIdSchema } from '../schemas/offre.schema.js';
...
router.post('/:id/accepter', authenticate, requireAdmin, validate(offreIdSchema), offreController.accepter);
